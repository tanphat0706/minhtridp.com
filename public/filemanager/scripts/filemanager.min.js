...
null;"user"==("undefined"===typeof b?"user":b)?0!=a.urlParam("config")?(b="./scripts/"+a.urlParam("config"),userconfig=a.urlParam("config")):(b="./scripts/filemanager.config.json",userconfig="filemanager.config.json"):b="./scripts/filemanager.config.json";a.ajax({async:!1,url:b,dataType:"json",cache:!1,success:function(a){e=a}});return e},R=v("default"),f=v();null!==f&&delete f.version;f=a.extend({},R,f);if(f.options.logger)var B=(new Date).getTime();HEAD_included_files=[];loadCSS=function(b){if(-1==
